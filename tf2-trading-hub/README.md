...
## 5.13.41 – Fast Dashboard Load & Faster Listing Fill
...
## 5.13.41 – Stock Count & Stack Sell Price Truth
...
## 5.13.41 – Affordable Candidate Rotation
...
## 5.13.41 – Cap-Fill Draft Prune & Actionable Rebuild
...
## 5.13.41 – Fallback Metrics & Stale Sell Listing Guard
...
## 5.13.41 – Crash Watchdog & Credential Vault Recovery
...
## 5.13.41 – Main Account Canonical Vault Save
...
## 5.13.41 – Live Dashboard Performance Pass
...
Re-publishes 5.13.41 with clean Home Assistant metadata files (`repository.yaml`, `config.yaml`, `build.yaml`, `run.sh`) and a fresh version bump so Supervisor can detect the update after repository cache issues.
